...
| --- | --- | --- | --- |
| Plume prediction | 1. Monitoring time series data <br> 2. Buliding height <br> 3. Distance function of sources | 1. Plume concentration <br> 2. Binary representation of plume | ![forward](doc/figs/forward.png) |
| Source detection | 1. Monitoring time series data <br> 2. Buliding height | 1. Distance function of sources <br> 2. Source strength | ![inverse](doc/figs/inverse.png) |
